...
<div class="">
    ...
    <div class="dash_thingy">
        <p>You have not joined any groups.</p>
        <h2 class="dash_h2 joinGroupButton"> Join a Group</h2>
        <div>
...
<div class="dash_thingy">
    <div class="loacalActivityBody">
        <div class="localActivityTag">Beach Clean</div>
