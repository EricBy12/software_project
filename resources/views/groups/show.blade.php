...
<div class="nunito1">
    ...
    @if(Auth::user()->role === "Organizer")
        <div class="dash_groupButtons edit_del">
            ...
            <a href="{{route('groups.edit', $group)}}"><h2 class="mt-2 mb-0 dash_h2 EditE nunito1 decoration-black">Edit Group</h2></a>
                        
                    <!-- route this to joined groups page? -->
            <form class="mb-0" action="{{route('groups.destroy', $group)}}" method="POST" onsubmit="return confirm('Are you sure you want to delete this group?')">
                @csrf
                @method('DELETE')
